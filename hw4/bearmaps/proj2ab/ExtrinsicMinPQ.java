 ...
 * i.e. are are supplied as an argument during insertion and can be changed
 * using the changePriority method.
 */
public interface ExtrinsicMinPQ<T> {
    ...
    /**
     * Changes the priority of the given item. Behavior undefined if the item
     * doesn't exist.
     */
