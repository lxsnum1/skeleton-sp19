...
public interface AStarGraph<Vertex> {
    ...
    /**
     * Provides an estimate of the number of moves to reach the goal from the start
     * position. For results to be correct, this estimate must be less than or equal
