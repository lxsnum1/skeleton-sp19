 ...
 * The process is defined as such that first the request parameters are read,
 * then request is process based on those parameters and finally the response is
 * built.
 *
 * Created by rahul
 */
